import {  FaCheck,  FaRegClipboard,  FaIndianRupeeSign,} from "react-icons/fa6";
function ResultCard({  result,  slab,  supply,  copied,  copyResult,  formatCurrency,}) {
  ...
  return (
    <div className="bg-green-100 border border-green-200 rounded-xl p-6 mb-5">
      <div className="flex justify-between items-center flex-wrap gap-3 mb-5">
        <div>
          <p className="uppercase text-xs font-bold tracking-wider text-green-700"> Total GST Amount </p>
  ...
  {formatCurrency(gstAmt)}
        ...
        <div className="text-right">
          <p className="uppercase text-xs font-bold tracking-wider text-green-700"> Final Amount</p>
  ...
  {formatCurrency(finalAmt)}
      ...
      <div className="border-t border-green-300 pt-4">
        <div className="flex justify-between py-2 border-b border-green-200">
          <span className="text-green-900"> Base Amount (excl. GST)  </span>
<span className="font-bold text-green-800 flex items-center gap-1">
  ...
  {formatCurrency(base)}
        ...
        {slab === 0 ? (
          <div className="flex justify-between py-2 border-b border-green-200">
            <span className="text-green-900">GST @ 0% </span>
           <span className="font-bold text-green-800 flex items-center gap-1">
  <FaIndianRupeeSign className="text-xs" />0.00</span>
          </div>
        ) : supply === "intra" ? (
          <>
            <div className="flex justify-between py-2 border-b border-green-200">
...
<span className="font-bold text-green-800 flex items-center gap-1">
  ...
  {formatCurrency(gstAmt / 2)}
          ...
          <div className="flex justify-between py-2 border-b border-green-200">
            <span className="text-green-900">  IGST @ {slab}%  </span>
<span className="font-bold text-green-800 flex items-center gap-1">
  <FaIndianRupeeSign className="text-xs" />
  {formatCurrency(gstAmt)}
</span>
